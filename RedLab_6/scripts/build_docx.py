"""Build RedLab_6's short-form solution walkthrough. Deliberately compact -
...
r = meta.add_run("Mastercard Innovation Challenge @ GFF 2026\n"
                ...
                "RedLab_2 and RedLab_7 for the other entries")
r.font.size = Pt(10.5)
r.font.color.rgb = GRAY
doc.add_page_break()
